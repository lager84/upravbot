  ...
  console.log(filteredObjects);
    ...
    >
        ...
        Активна
            ...
            <Field name="objects" component={DispObjects} filteredObjects={filteredObjects}/>
            <Field name="dispetcher" component={DispUsers} users={dispetcher} headerText="Диспетчер" />
            <Field name="otvetstvenniy" component={DispUsers} users={otvetstvenniy} headerText="Ответственный" />
            <Field name="ispolnitel" component={DispUsers} users={ispolnitel} headerText="Исполнитель" />
