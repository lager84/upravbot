...
const InputComponent:FC<TProps> = ({children , id_name, value , type, disabled  , classCss , name, onChange  }) =>{
...
<input type={type} onChange={onChange} name={name} value={value || "" } id={id_name} disabled={disabled}  className={classCss}></input>
