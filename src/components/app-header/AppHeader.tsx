    ...
    <header className="internal1 h90">
       <div className="headerWrapper">
         ...
         <li className="nav-item">               
                    <a title="Меню" className={!state? "collapsed flexCenter pt-1":"flexCenter pt-1"} onClick={menuMob}  data-toggle="collapse" href="#collapse0">                      
                        <span className="if-collapsed">
                            <img src={menu2} className="mr-2" alt=""></img></span>                                                                        
                        <span className="if-not-collapsed">
                            <img src={close} className="mr-2" alt=""></img></span> 
                       {state && 
