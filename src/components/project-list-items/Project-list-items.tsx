...
const ProjectListItem: FC<TProp> = ({ card, refetch }) => {
  ...
  const [updateProject, { loading: loading_upd_Pr, error: error_upd_Pr }] =
  ...
  const [deleteProject, { loading: loading_del_Pr, error: error_del_Pr }] =
    useMutation(
      DELETE_PROJECT
      // ,{
      // update: (cache, {data}) => {
  ...
  return (
    ...
    >
      <div className={styles.divCard}>
        ...
        {disable && (
          <button
            className="administrator_button__WAzsm"
            type="button"
            title="редактировать"
            onClick={onDisable}
          >
            <img
              src="/static/media/tasks-ic-bl.3e35cee28294ee173b3c7a76f6cf3529.svg"
        ...
        >
          <img
            src="/static/media/ic-bin.b2f853337f6ee57b98d1fd97194cbe3c.svg"
            className="w24 reddishSvg mr-2 ml-2"
            alt=""
          ></img>
        </button>
